...
public class TelaRanking extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Gerar Ranking");
        ...
        tabelaRanking.setAutoCreateRowSorter(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Model.Sorteio model = new Model.Sorteio(0,0,0,0,0,0,0);
        Control.AnaliseController control = new Control.AnaliseController();

        // 1. Pega os dados
        List<Model.Sorteio> lista = model.buscarTodosDoBanco();
        // 2. Recebe o mapa de contagem (1 a 60)
        Map<Integer, Integer> ranking = control.calcularFrequencia(lista);

        // 3. Preenche a tabela
        for (int i = 1; i <= 60; i++) {
            modelo.addRow(new Object[]{ i, ranking.get(i) });
        }
